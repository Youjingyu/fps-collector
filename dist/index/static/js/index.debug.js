...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_collect_animation_fps__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_collect_scroll_fps__ = __webpack_require__(14);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__core_collect_animation_fps__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1__core_collect_scroll_fps__["a"]; });
...
var collector=new __WEBPACK_IMPORTED_MODULE_0__index__["a" /* collectAnimationFps */]({duration:5000});collector.start();collector.on('end',function(data){console.log(data);});var scrollCollector=new __WEBPACK_IMPORTED_MODULE_0__index__["b" /* collectScrollFps */]({threshold:2});scrollCollector.start();var span=document.getElementById('test');scrollCollector.on('end',function(data){span.textContent=data.fps+';'+data.speed+';'+data.quickScroll;console.log(data);});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_collect_fps__ = __webpack_require__(1);
